 ...
 * @type {SpacingType}
 */
export declare type SpacingType = 'margin' | 'padding';
/**
 ...
 * @enum {number}
 */
export declare enum SpacingDirection {
    Top = "top",
    Bottom = "bottom",
    Left = "left",
    Right = "right",
 ...
 * @returns
 */
export declare function getSpacingPropertyName(property: string, direction: SpacingDirection): string;
/**
 ...
 */
export default function (type: SpacingType, shortname: string, property: string, { e, theme, variants, addUtilities }: any): void;
export declare function getConfigType(type: SpacingType, theme: any): any;
export declare const negativeSpacingConfig: (theme: any) => any;
export declare const spacingConfig: (theme: any) => any;
